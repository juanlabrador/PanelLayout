package com.github.juanlabrador.panellayout.switchbutton;
...
/**
 * Created by juanlabrador on 14/01/15.
 * 
 * Class taken from https://github.com/kyleduo/SwitchButton/blob/master/SwitchButton/src/com/kyleduo/switchbutton/Configuration.java
 */
public class Configuration implements Cloneable {

    static class Default {
        static int DEFAULT_OFF_COLOR = Color.parseColor("#CCCCCC");
