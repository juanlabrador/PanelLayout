...
import com.github.juanlabrador.panellayout.R;

/**
 * Created by juanlabrador on 14/01/15.
 * 
 * Class taken from https://github.com/kyleduo/SwitchButton/blob/master/SwitchButton/src/com/kyleduo/switchbutton/SwitchButton.java
 */
